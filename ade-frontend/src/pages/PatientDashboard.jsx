  ...
  return (
    <div className="container" id="patient-dashboard-container">
      ...
      <div className="dashboard-content">
        <div id="patient-dashboard-header">
              ...
              {checks.map((check) => (
                <div className="" id="patient-dashboard-card" key={check.id}>
                  <div className="card-header">
                    <strong>
                      {check.doctorName}, {check.doctorSpecialty}
                    </strong>
                    <span className="badge green">Profil</span>
                  </div>
                  <p>
                    <strong>Symptômes :</strong> {check.symptoms}
                  </p>
                  <p>
                    <strong>Résultat :</strong> {check.result}
                  </p>
                  <p>
                    <strong>Réponse du médecin :</strong> {check.notes}
                  </p>
                    ...
                    {check.notes &&
                      (check.notes === "Veuillez prendre rdv" ? (
                        <button
                          className="btn pink"
                          onClick={() =>
                            (window.location = `/consult/${check.id}`)
                          }
                        >
                        ...
                        <button
                          className=""
                          onClick={() =>
                            (window.location = `/pharmacy/${check.id}`)
                          }
                        >
                          Pharmacie
                        </button>
            ...
            <div className="grid">
              {appointments.map((rdv) => (
                <div className="card" key={rdv.id}>
                  <div className="card-header">
                    <strong>
                      {rdv.doctorName}, {rdv.doctorSpecialty}
                    </strong>
                    <span className="badge green">Profil</span>
                  </div>
                  <p>
                  ...
                  <div className="card-actions">
                    <button
                      className="btn green"
                      onClick={() =>
                        (window.location = `/appointment/${rdv.id}`)
                      }
                    >
                      Aller
                    </button>
